...
The Dynamsoft Core module lays the foundation for Dynamsoft SDKs based on the [DCV (Dynamsoft Capture Vision) architecture]({{ site.dcvb_js}}). It encapsulates the basic classes, interfaces, and enumerations shared by these SDKs.

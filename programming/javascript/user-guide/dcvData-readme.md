...
This package includes machine learning models for barcode reading, text recognition, and border detection, as well as string parsing resources and template files, empowering various foundational products under [DCV (Dynamsoft Capture Vision) architecture]({{ site.dcvb_js}}).
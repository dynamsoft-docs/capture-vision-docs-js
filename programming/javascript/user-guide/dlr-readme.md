...
The Dynamsoft Label Recognizer module identifies and recognizes text labels such as passport MRZs, ID cards, and VIN numbers. To learn more, please refer to [Dynamsoft Capture Vision architecture]({{ site.dcvb_js}}).
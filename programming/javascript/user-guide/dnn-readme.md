...
The Dynamsoft Neural Network module allows SDKs compliant with the [Dynamsoft Capture Vision architecture]({{ site.dcvb_js}}). to leverage the power of deep learning when processing digital images.
...
- [User Guide for Dynamsoft Barcode Reader]({{ site.dbr_js}}user-guide/barcode-scanner.html){:target="_blank"}

- [User Guide for MRZ Scanner]({{ site.mrz_js}}guides/mrz-scanner.html){:target="_blank"}
